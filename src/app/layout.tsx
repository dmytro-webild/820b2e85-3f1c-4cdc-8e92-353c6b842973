...
export const metadata: Metadata = {
  title: "Smile Dental Center | Luxury Dental Clinic Toronto",
  description: "Experience gentle, modern dentistry in Toronto. 4.9★ rated dental clinic specializing in comfortable care for nervous patients, cosmetic dentistry, and prevention-focused treatment.",
  keywords: "dental clinic toronto, dentist toronto, family dentistry, cosmetic dentistry, emergency dental care, smile dental center",
  metadataBase: new URL("https://smiledentalcenter.com"),
  alternates: {
    canonical: "https://smiledentalcenter.com",
  },
  openGraph: {
    title: "Smile Dental Center - Gentle, Modern Dentistry You Can Trust",
    description: "Experience exceptional dental care at Toronto's most trusted clinic. 4.9★ rated with 1,100+ happy patients.",
    url: "https://smiledentalcenter.com",
    siteName: "Smile Dental Center",
    images: [
      {
        url: "https://smiledentalcenter.com/og-image.jpg",
        alt: "Smile Dental Center - Professional dental clinic",
      },
    ],
    type: "website",
  },
  twitter: {
    ...
    title: "Smile Dental Center - Gentle, Modern Dentistry",
    description: "Experience exceptional dental care. 4.9★ rated clinic in Toronto with a focus on patient comfort.",
    images: ["https://smiledentalcenter.com/twitter-image.jpg"],
  },
  robots: {
    index: true,
    follow: true,
